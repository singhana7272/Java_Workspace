	...
	public void performMenu(char choice) {
		...
		try {
			...
			case '3':
				...
				boolean statusDeregister = courseService.deregisterEmployeeForCourse(deregisterCourseId,
						deregisterEmployee);
		...
		} catch (EmployeeNotFoundException | CourseNotFoundException | CourseRegisterationFullException
				exp) {
			System.out.println(exp.getMessage());
		}
		catch(InputMismatchException exp) {
			InvalidInputException ex=new InvalidInputException("Please enter valid input.");
