...
public class EmployeePresentationImpl implements EmployeePresentation{
	...
	public void showMenu() {
		...
		System.out.println("5.List All Participants for specific course");
	...
	public void performMenu(int choice) {
		...
		case 5:
			System.out.println("Enter course id");
			courseId=scanner.nextLine();
			ArrayList<EmployeeCourse> employeesCourse=null;
			employeesCourse=employeeService.showAllEmployeesWithCourseForCourseId(courseId);
			for(EmployeeCourse employee:employeesCourse) {
				System.out.println(employee);
			}
			break;
		case 6:
